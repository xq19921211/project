...
class OperateLogRecordManagement extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const list = [
      ...
      {
        label: '操作日志',
        to: '/index/operateLogRecordManagement',
      },
    ];
    return (
      <Layout id="operate_log_record_management">
...
const OperateLogRecordManagementForm = Form.create()(
  OperateLogRecordManagement,
);
...
export default connect(
  mapStateToProps,
  mapDispatchToProps,
)(OperateLogRecordManagementForm);
  ...
  render() {
    ...
    const data = logRecordList.dataSource.map((item, i) => {
      return {
        ...
        operateTime: !item.createTime ? '' : item.createTime,
      };
    });
    const options = {
